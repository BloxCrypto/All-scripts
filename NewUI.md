# Introduction
![Blueflare](https://raw.githubusercontent.com/Nebula-Softworks/Blueflare-Interface-Suite/refs/heads/master/Blueflare%20Cover%20Image.png)
This Documentation Is Last Updated for Prerelease Beta 6.1
## Why Choose Blueflare?
  Reliable And Stable  
  Beautful Design  
  Open Sourced  
...
# Documentation For Blueflare
## Booting The Library
```lua
local Blueflare = loadstring(game:HttpGet("https://raw.githubusercontent.com/Nebula-Softworks/Blueflare-Interface-Suite/refs/heads/master/source.lua", true))()
```
> This loads up the library to use our Elements. No parameters required

> [!NOTE]
> Blueflare Gives The User The Option To Load, Save And Autoload Their Own Configurations So manually loading them isnt required

## Windows
#### Creating The Window
Sadly, Unlike Older Projects, Blueflare Can't Have Multiple Windows. But It's Fine! Right?  

> [!IMPORTANT]
> Blueflare's Glassmorphism Requires Graphics Level 8 Or Above

```lua
local Window = Blueflare:CreateWindow({
	Name = "Blueflare Example Window", -- This Is Title Of Your Window
	Subtitle = nil, -- A Gray Subtitle next To the main title.
	LogoID = "82795327169782", -- The Asset ID of your logo. Set to nil if you do not have a logo for Blueflare to use.
	LoadingEnabled = true, -- Whether to enable the loading animation. Set to false if you do not want the loading screen or have your own custom one.
	LoadingTitle = "Blueflare Interface Suite", -- Header for loading screen
	LoadingSubtitle = "by Nebula Softworks", -- Subtitle for loading screen

	ConfigSettings = {
		RootFolder = nil, -- The Root Folder Is Only If You Have A Hub With Multiple Game Scripts and u may remove it. DO NOT ADD A SLASH
		ConfigFolder = "Big Hub" -- The Name Of The Folder Where Blueflare Will Store Configs For This Script. DO NOT ADD A SLASH
	},

	KeySystem = false, -- As Of Beta 6, Blueflare Has officially Implemented A Key System!
	KeySettings = {
		Title = "Blueflare Example Key",
		Subtitle = "Key System",
...
```
> [!IMPORTANT]
> Make sure to always add this code ``Blueflare:LoadAutoloadConfig()`` at the bottom of your script!
> Blueflare will now automatically load up your saved configuration 😄

#### Blueflare Icons
Blueflare Uses Custom Icons so u do not have to find ans upload your own!
...
> [!WARNING]
> Destroying Blueflare Does Not Toggle Off Your Scripts So When Destroying, make sure you disable them first
```
Blueflare:Destroy()
```
...
```lua
Blueflare:Notification({ 
	Title = "Blueflare Notification Example",
	Icon = "notifications_active",
	ImageSource = "Material",
	Content = "This Is A Preview Of Blueflare's Dynamic Notification System Entailing Estimated/Calculated Wait Times, A Sleek Design, Icons, And A Glassmorphic Look"
})
```
...
#### Changing The Window Keybind Using Blueflare's Binded Keys
```lua
local Bind = Tab:CreateBind({
	Name = "Blueflare Interface Bind",
	Description = nil,
...
To check the current value of an existing element, using the variable, you can do ElementName.CurrentValue, if it's a dropdown or colorpicker, you will need to use DropdownName.CurrentOption or ColorpickerName.CurrentColor You can also check it via the flags from Blueflare.Options
...
> [!NOTE]
> Blueflare Paragraphs Automatically Size To Your text!

#### Creating A Label
```lua
local Label = Tab:CreateLabel({
	Text = "Label Example",
	Style = 1 -- Blueflare Labels Have 3 Styles : A Basic Label, A Green Information Label and A Red Warning Label. Look At The Following Image For More Details
})
```
> [!TIP]
...
### Adding A Home Tab.
As Of Beta 4, Blueflare has implemented a Premade Home tab with a information dashboard similar to Sirius and Eclipse Hub.
```lua
...
#### Setting Up Theming
As Of Beta 4, Blueflare has implemented theming. Users may change the accent of the Interface using Color Pickers or Using Preset Colors handpicked by Nebula Softworks
```lua
