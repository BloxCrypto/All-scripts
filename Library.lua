...
if not isfolder("Blueflare") then
    makefolder("Blueflare")
end
if not isfolder("Blueflare/Config") then
    makefolder("Blueflare/Config")
end
...
local ConfigFile = "Blueflare/Config/Blue" .. gameName .. ".json"
...
function Chloex:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Title = NotifyConfig.Title or "Blueflare"
...
function Chloex:Window(GuiConfig)
    ...
    GuiConfig.Title        = GuiConfig.Title or "Blueflare"
